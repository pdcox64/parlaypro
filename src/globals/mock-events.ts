...
export const MARKETS: Markets[] = [
    ...
    {id: 50, market1: 'Caroline Wozniacki', market2: 'Anastasija Sevastova', event: 6, date: 7 },
    {id: 50, market1: 'Elina Svitolina', market2: 'Elise Mertens', event: 6, date: 7 },
    {id: 50, market1: 'Naomi Osaka', market2: 'Julia Goerges', event: 6, date: 7 },
    {id: 50, market1: 'Sloane Stephens', market2: 'Ashleigh Barty', event: 6, date: 7 },
    {id: 50, market1: 'Petra Kvitova', market2: 'Serena Williams', event: 6, date: 7 },
    {id: 50, market1: 'Karolina Pliskova', market2: 'Madison Keys', event: 6, date: 7 },
    {id: 50, market1: 'Kiki Bertens', market2: 'Garbine Muguruza', event: 6, date: 7 },

    // MLB American league
    
    {id: 51, market1: 'Toronto Blue Jays', market2: 'New York Yankees', event: 7, date: 8 },
    {id: 52, market1: 'Chicago White Sox', market2: 'Boston Red Sox', event: 7, date: 8 },
    {id: 53, market1: 'Tampa Bay Rays', market2: 'Baltimore Orioles', event: 7, date: 8 },
    {id: 54, market1: 'Texas Rangers', market2: 'Cleveland Indians', event: 7, date: 8 },
    {id: 55, market1: 'Minnesota Twins', market2: 'Detroit Tigers', event: 7, date: 8 },
    {id: 56, market1: 'Los Angeles Angels', market2: 'Houston Arrows', event: 7, date: 8 },
    {id: 57, market1: 'Oakland Athletics', market2: 'Kansas City Royals', event: 7, date: 8 },
    {id: 58, market1: 'Minnesota Twins', market2: 'Seattle Mariners', event: 7, date: 8 },
    
    
    // MLB National League
    {id: 58, market1: 'Mailwaukee Brewers', market2: 'Arizona Diamondbacks', event: 10, date: 12 },
    {id: 59, market1: 'New York Mets', market2: 'Atlanta Braves', event: 10, date: 12 },
    {id: 60, market1: 'Philadelphia Phillies', market2: 'Chicago Cubs', event: 10, date: 12 },
    {id: 61, market1: 'Pittsburgh Pirates', market2: 'Cincinnati reds', event: 10, date: 12 },
    {id: 62, market1: 'San Diego Padres', market2: 'Colorado Rockies', event: 10, date: 12 },
    {id: 63, market1: 'San Francisco Giants', market2: 'Los Angeles Dodngers', event: 10, date: 12 },
    {id: 64, market1: 'St. Louis Cardinals', market2: 'Miami Marlins', event: 10, date: 12 },
     
    // Basketball - NBA 
    {id: 65, market1: 'L.A Lakers', market2: 'Toronto Raptors', event: 8, date: 9 },
    {id: 66, market1: 'Boston Celtics', market2: 'New York Knicks', event: 8, date: 9 },
    {id: 67, market1: 'Chicago Bulls', market2: 'Miami Heat', event: 8, date: 9 },
    {id: 68, market1: 'Atlanta Hawks', market2: 'Golden State Warriors', event: 8, date: 9 },
    {id: 69, market1: 'Brooklyn Nets', market2: 'Houston Rockets', event: 8, date: 9 },
    {id: 70, market1: 'Charlotte Hornets', market2: 'Indiana Pacers', event: 8, date: 9 },
    {id: 71, market1: 'Cleveland Cavaliers', market2: 'LA Clippers', event: 8, date: 9 },
    {id: 72, market1: 'Dallas Mavericks', market2: 'Memphis Grizzlies', event: 8, date: 9 },
    {id: 73, market1: 'Denver Nuggets', market2: 'Milwaukee Bucks', event: 8, date: 9 },
    {id: 74, market1: 'Detroit Pistons', market2: 'New Orleans Pelicans', event: 8, date: 9 },
];
